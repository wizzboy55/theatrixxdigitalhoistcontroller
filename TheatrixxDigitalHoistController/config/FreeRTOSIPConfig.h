...
/* Define the Link Layer IP address: 192.168.x.x */
#define LINK_LAYER_ADDRESS_0	192
#define LINK_LAYER_ADDRESS_1	168

extern unsigned int uxRand();
#define ipconfigRAND32()	uxRand()

/* Prototype for the function used to print out.  In this case it prints to the
console before the network is connected then a UDP port after the network has
connected. */
extern void debug_printf( const char *pcFormatString, ... );
...
#define ipconfigHAS_DEBUG_PRINTF	0
	...
	#define FreeRTOS_debug_printf(X)	debug_printf X
#endif
...
//#define ipconfigIP_TASK_STACK_SIZE_WORDS	( configMINIMAL_STACK_SIZE * 2 )
...
#define ipconfigMAXIMUM_DISCOVER_TX_PERIOD		( 12000 / portTICK_PERIOD_MS )
...
// Tied to NetworkInterface buffers!
#define ipconfigNETWORK_MTU		1004
...
#define ipconfigPACKET_FILLER_SIZE 6
...
#define ipconfigTCP_HANG_PROTECTION				( ipconfigUSE_TCP )
#define ipconfigTCP_HANG_PROTECTION_TIME		( 30 )

/* Include support for TCP keep-alive messages. */
#define ipconfigTCP_KEEP_ALIVE				( ipconfigUSE_TCP )
